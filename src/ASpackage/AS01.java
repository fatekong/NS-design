...
class ASThread01 extends Thread{
...
//				System.out.println(TS1);
				...
				if(month == Integer.parseInt(ts[0]) && date == Integer.parseInt(ts[1]) && hour == Integer.parseInt(ts[2])) {
					if(minute - Integer.parseInt(ts[3])<1) {
						...
						ticket_to_tgs = des.encode(ticket_to_tgs_before, ktgs);
						System.out.println("第一次加密：" + ticket_to_tgs);
						ticket_to_tgs = des.encode(ticket_to_tgs, kc);
						System.out.println("第二次加密：" + ticket_to_tgs);
						
						System.out.println("第一次解密：" + des.decode(ticket_to_tgs, kc));
						System.out.println("第二次解密：" + des.decode(des.decode(ticket_to_tgs, kc), ktgs));
...
public class AS01 {
	...
	public static void main(String[] args) throws IOException {
		...
		ASThread01 forclient1 = new ASThread01(10000);
		ASThread01 forclient2 = new ASThread01(10001);
		ASThread01 forclient3 = new ASThread01(10002);
		ASThread01 forclient4 = new ASThread01(10003);
